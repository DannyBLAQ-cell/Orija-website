...
<div  className="mb-5">
    <h3 className="text-3xl primary font-semibold mb-4 text-center"> <i>Getting Started</i></h3>
...
{/* Category: Selling */}
<div className="mb-5">
<h3 className="text-3xl font-semibold mb-4 primary text-center"><i>Selling</i></h3>
<Faqitem
...
{/* Category: Buying */}
<div className="mb-5">
<h3 className="text-3xl font-semibold mb-4 primary text-center"><i>Buying</i></h3>
<Faqitem
...
<div className="mb-5">
<h3 className="text-3xl font-semibold mb-4 primary text-center"><i>Payments & Safety</i></h3>
<Faqitem
